...
fetch(url)
    ...
    .then(teddies =>{
        ...
        teddies.forEach(({_id, name, description, price, imageUrl}) =>{
            // Etape 1: Création des nouveaux éléments à l'aide de createElement ou createTextNode
            ...
            // Etape 3: Insertion des nouveaux éléments dans le DOM grâce à la méthode appendChild
            ...
            a.className = "btn btn-info offset-6 m-3"
        })
    })
